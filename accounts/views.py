...
def market_list(request):
    ...
    return render(request, 'accounts/market/list.html', {'products': products})
...
def market_detail(request, pk):
    ...
    return render(request, 'accounts/market/detail.html', {
        'product': product,
        'comments': comments,
        'is_liked': is_liked,
...
def market_purchase(request, pk):
    ...
    return render(request, 'accounts/market/purchase_confirm.html', {'product': product})
...
def admin_product_add(request):
    ...
    return render(request, 'accounts/admin/product_form.html', {'title': "Mahsulot qo'shish"})
...
def admin_product_edit(request, pk):
    ...
    return render(request, 'accounts/admin/product_form.html', {'title': "Mahsulotni tahrirlash", 'product': product})
...
def admin_product_delete(request, pk):
    ...
    return render(request, 'accounts/admin/product_delete.html', {'product': product})
...
def admin_purchases(request):
    ...
    return render(request, 'accounts/admin/purchases.html', {'purchases': purchases})
...
def admin_activities(request):
    ...
    return render(request, 'accounts/admin/activities.html', {
